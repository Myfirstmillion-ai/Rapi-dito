        ...
        >
          <div className="px-6 py-8 pb-12">
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">Comienza a ganar hoy</p>
            </motion.div>
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-gray-600 dark:text-white/60 text-sm">
                ...
                <Link to="/login" className="font-bold text-gray-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
