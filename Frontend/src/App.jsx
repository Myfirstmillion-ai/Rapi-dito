...
function App() {
  return (
    <div className="w-full min-h-screen-safe flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100">
      <div className="relative w-full sm:min-w-[400px] sm:max-w-[430px] md:max-w-[400px] min-h-screen-safe sm:h-[95vh] sm:max-h-[900px] bg-white overflow-hidden sm:rounded-3xl sm:shadow-2xl transition-all duration-300 ease-in-out">
