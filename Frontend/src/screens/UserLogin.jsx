...
import { Mail, Lock, ArrowRight, Shield, Star } from "lucide-react";
  ...
  return (
    <div className="relative w-full h-dvh overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(135deg, rgba(39,110,241,0.92) 0%, rgba(31,88,193,0.95) 100%),
            url('https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1600&q=90')
          `,
        ...
        <div className="relative h-full flex flex-col justify-between p-8">
          ...
          <div>
            <div className="inline-block px-4 py-1.5 bg-white/20 backdrop-blur-sm rounded-full mb-4">
              <span className="text-sm font-semibold text-white">Viajeros</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-white mb-3 leading-tight">
              ¡Te damos la<br/>bienvenida!
            </h1>
            <p className="text-lg text-white/95 font-medium">
              Inicia sesión y comienza tu viaje
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md mx-auto">
          <form onSubmit={handleSubmit(loginUser)} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link 
                ...
                className="text-sm font-semibold text-uber-blue hover:text-blue-700 transition-colors"
              >
          ...
          <div className="space-y-4">
            <p className="text-sm text-center text-gray-600">
              ...
              <Link to={"/signup"} className="font-bold text-uber-blue hover:text-blue-700 transition-colors">
                Regístrate gratis
              </Link>
            </p>

            <button
              onClick={() => navigation("/captain/login")}
            ...
            >
              <span>Inicia sesión como Conductor</span>
